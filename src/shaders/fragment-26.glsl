...
void main(){
  ...
  color.r = stroke(snoise(uv1 * 2. +wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , .5  )), .5, .2);
  color.g = stroke(snoise(uv2 * 2. +wiggly(rote.x + vTime * .005, rote.y + vTime * .005, .2, 6. , .5  )), .5, .2);
  color.b = stroke(snoise(uv3 * 2. +wiggly(rote2.x + vTime * .005, rote2.y + vTime * .005, .2, 6. , .5  )), .5, .2);


  color.r *= stroke(spiralSDF(uv, 1.13 * sin(vTime * .5)), .1,.4);
  color.g *= stroke(spiralSDF(uv, 1.13 * cos(vTime * .5)), .1,.4);
  color.b *= stroke(spiralSDF(uv, 1.13 * sin(vTime * .3)), .1,.4);
