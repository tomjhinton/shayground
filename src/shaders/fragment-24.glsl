...
void main(){
  ...
  // pMod2(uv, );
  color.r = stroke(cnoise(vec2(smoothstep(.2
    +wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , 1.5  ),
     .6 + wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , 1.5  ), sin(vTime) ), .2 ) * 1. ),
  .2 +wiggly(uv.x + vTime * .005, uv.y + vTime * .005, .2, 6. , .5  ) , .2 );

  color.g = stroke(cnoise(vec2(smoothstep(.3
    +wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , 1.5  ),
     .8 + wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , 1.5  ), sin(vTime) ), .2 ) * 1. ),
  .2 +wiggly(uv.x + vTime * .005, uv.y + vTime * .005, .2, 6. , .5  ) , .2 );

  color.b = stroke(cnoise(vec2(smoothstep(.7
    +wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , 1.5  ),
     .8 + wiggly(roteC.x + vTime * .005, roteC.y + vTime * .005, .2, 6. , 1.5  ), sin(vTime) ), .2 ) * 1. ),
  .2 +wiggly(uv.x + vTime * .005, uv.y + vTime * .005, .2, 6. , .5  ) , .2 );
