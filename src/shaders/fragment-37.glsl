...
void main(){
  ...
  color = mix(color, 1.-color, stroke(raysSDF(rote, 15. ), .2 , .8));
  ...
  color = mix(color, 1.-color, stroke(polySDF(uv1, 7. ), .2, 1.3));
  color = mix(color, 1.-color, stroke(raysSDF(rote, 10. ), .2 , .8));
  color = mix(color, 1.-color, stroke(polySDF(uv1, 7. ), .2, .75));
  color = mix(color, 1.-color, stroke(polySDF(uv1, 5. ), .2, .375));
